...
- After hiring or creating an agent, verify the managed instructions bundle before marking the hiring work complete. The minimum acceptable bundle is `AGENTS.md`, `SOUL.md`, `HEARTBEAT.md`, and `TOOLS.md`.
- If any of the four files are missing, create them in the same heartbeat or leave the hiring issue open with explicit follow-up ownership.
