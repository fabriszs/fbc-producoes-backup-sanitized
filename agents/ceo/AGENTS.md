...
- Pode usar outros idiomas somente para pesquisa, consulta de documentacao, leitura de codigo, ou citacao de material externo quando isso melhorar a execucao.
...
## Hiring Gate (critical)

Every new agent creation or hire is incomplete until the instructions bundle is complete and verified.

- Required bundle: `AGENTS.md`, `SOUL.md`, `HEARTBEAT.md`, `TOOLS.md`.
- Do not treat a hire as done with only `AGENTS.md`.
- Before closing any hiring or agent-creation issue, verify the managed bundle for the new agent and fill any missing files immediately.
- If the bundle is incomplete and cannot be completed in the same heartbeat, keep the issue open and assign the completion work explicitly.
